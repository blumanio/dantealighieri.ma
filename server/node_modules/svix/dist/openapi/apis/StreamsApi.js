...
exports.StreamsApiResponseProcessor = exports.StreamsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class StreamsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    appendToStream(appId, createStreamIn, idempotencyKey, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError('Required parameter appId was null or undefined when calling appendToStream.');
            }
            if (createStreamIn === null || createStreamIn === undefined) {
                throw new baseapi_1.RequiredError('Required parameter createStreamIn was null or undefined when calling appendToStream.');
            }
            const localVarPath = '/api/v1/app/{app_id}/stream'
    ...
    listStream(appId, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError('Required parameter appId was null or undefined when calling listStream.');
            }
            const localVarPath = '/api/v1/app/{app_id}/stream'
                .replace('{' + 'app_id' + '}', encodeURIComponent(String(appId)));
...
exports.StreamsApiRequestFactory = StreamsApiRequestFactory;
class StreamsApiResponseProcessor {
    appendToStream(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    listStream(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListResponseEventOut", "");
                return body;
            }
            if (util_1.isCodeInRange("400", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "HttpErrorOut", "");
...
exports.StreamsApiResponseProcessor = StreamsApiResponseProcessor;
